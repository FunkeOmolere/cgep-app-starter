...
provider "aws" {
  ...
  # CM-6: Required compliance tags applied to every taggable resource.
  # Removes the chance of forgetting them.
  default_tags {
    tags = {
...
# AC-3: Explicit deny on every public access vector.
...
# AU-3 / AU-6: Audit records + audit review.
